						...
						<div class="card">
							<div class="card-body">
								<div class="card-title" style="text-align: center;">Sản
									phẩm mới</div>
								<hr>
								<form action="/add-product-s" modelAttribute="product"
									method="post">
									...
									<div class="form-group">
										<label for="input-1">Tên</label> <input type="text"
											class="form-control" id="input-1" name="name" required>
									</div>
									<div class="form-group">
										<label for="input-1">Image</label> <input type="file"
											class="form-control" id="input-1" name="imge" required>
									</div>
									<div class="form-group">
										<label for="input-1">Giá</label> <input type="text"
											class="form-control" id="input-1" name="price" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="input-1">Loại màn hình</label> <input type="text"
											class="form-control" id="input-1" name="screen" required>
									</div>
									<div class="form-group">
										<label for="input-2">Mô tả</label>
										<textarea rows="20" cols="20" id="editer_des" name="des"></textarea>
									</div>
									<div class="form-group"
										style="display: flex; justify-content: center;">
