						...
						<div class="card">
							<div class="card-body">
								<div class="card-title" style="text-align: center;">Sản
									phẩm mới</div>
								<hr>
								<form action="/change-product1" modelAttribute="product"
									method="post">

									<div class="form-group">
										<label for="input-1">ID</label> <input type="text"
											class="form-control" id="input-1" name="id"
											value="${product.id}">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="input-1">Image</label> <input type="file"
											class="form-control" id="input-1" name="imge"
											value="${product.img}">
									</div>
									<div class="form-group">
										<label for="input-1">Giá</label> <input type="text"
											class="form-control" id="input-1" name="price"
											value="${product.price}">
									</div>
									<div class="form-group">
										<label for="input-1">Hãng xe</label> <select id="cars"
									...
									<div class="form-group">
										<label for="input-1">Loại xe</label> <select id="carItems"
											class="form-select" name="carItem"
											aria-label="Default select example">
										</select>
									</div>

									<div class="form-group">
										<label for="input-1">Loại màn hình</label> <input type="text"
											class="form-control" id="input-1" name="screen"
											value="${product.screen.name}">
									</div>
									<div class="form-group">
										<label for="input-2">Mô tả</label>
										<textarea rows="20" cols="20" id="editer_des" name="des">${product.productDetail.discription}</textarea>
									</div>
									<div class="form-group"
										style="display: flex; justify-content: center;">
