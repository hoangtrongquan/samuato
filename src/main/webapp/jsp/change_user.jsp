						...
						<div class="card">
							<div class="card-body">
								<div class="card-title" style="text-align: center;">Sản
									phẩm mới</div>
								<hr>
								<form action="/change-user1" modelAttribute="product" method="post">

									<div class="form-group">
										<label for="input-1">ID</label> <input type="text"
											class="form-control" id="input-1" value="${user.id}"
											name="id">
									</div>
									<div class="form-group">
										<label for="input-1">Tên</label> <input type="text"
											class="form-control" id="input-1" name="name" value="${user.name}" required>
									</div>
									<div class="form-group">
										<label for="input-1">Số điện thoại</label> <input type="text"
											class="form-control" id="input-1" name="phone" value="${user.phone}" required>
									</div>
									<div class="form-group">
										<label for="input-1">Địa chỉ</label> <input type="text"
											class="form-control" id="input-1" name="address" value="${user.address}" required>
									</div>
									<div class="form-group">
										<label for="input-1">Note</label> <input type="text"
											class="form-control" id="input-1" name="note" value="${user.note}">
									</div>
									<div class="form-group"
										style="display: flex; justify-content: center;">
