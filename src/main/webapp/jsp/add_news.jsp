						...
						<div class="card">
							<div class="card-body">
								<div class="card-title" style="text-align: center;">Sản
									phẩm mới</div>
								<hr>
								<form action="/add-news1" modelAttribute="product" method="post">
									...
									<div class="form-group">
										<label for="input-1">Tác giả</label> <input type="text"
											class="form-control" id="input-1" name="author" required>
									</div>
									<div class="form-group">
										<label for="input-1">Image</label> <input type="file"
											class="form-control" id="input-1" name="img" required>
									</div>
									<div class="form-group">
