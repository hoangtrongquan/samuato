						...
						<div class="card">
							<div class="card-body">
								<div class="card-title" style="text-align: center;">Sản
									phẩm mới</div>
								<hr>
								<form action="/add-agencyS" modelAttribute="product" method="post">
									...
									<div class="form-group">
										<label for="input-1">Địa chỉ</label> <input type="text"
											class="form-control" id="input-1" name="address" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="input-1">Địa chỉ</label> <input type="text"
											class="form-control" id="input-1" name="hrefAdd" required>
									</div>
									<div class="form-group">
										<label for="input-1">Tỉnh/ thành</label> <input type="text"
											class="form-control" id="input-1" name="province">
									</div>
									<div class="form-group"
										style="display: flex; justify-content: center;">
